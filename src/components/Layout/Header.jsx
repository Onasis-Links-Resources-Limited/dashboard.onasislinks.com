      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative hidden md:block">
          ...
          <input
            type="text"
            placeholder="Search..."
            className="pl-9 pr-4 py-2 w-64 border border-gray-200 dark:border-gray-700 rounded-lg bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white text-sm focus:ring-2 focus:ring-[#C3110C] focus:border-transparent transition"
          />
        </div>
      </div>
