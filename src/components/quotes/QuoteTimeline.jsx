...
const QuoteTimeline = ({ timeline = [] }) => {
  ...
  return (
    <div className="bg-white dark:bg-[#1A1A1A] border border-gray-200 dark:border-[#1A1A1A] rounded-xl p-5">
      ...
      <ol className="relative border-l border-gray-200 dark:border-gray-800 ml-2 space-y-5">
        {timeline.map((event, i) => (
          <li key={i} className="ml-4">
            <span className="absolute -left-1.25 w-2.5 h-2.5 rounded-full bg-[#C3110C] dark:bg-[#E6501B] mt-1.5" />
